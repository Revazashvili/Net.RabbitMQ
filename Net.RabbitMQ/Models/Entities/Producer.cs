...
namespace Net.RabbitMQ.Models.Entities
{
    public class Producer : IProducer
    {
        ...
        public Producer(IForbid forbid,IConnectionProvider connectionProvider, RabbitMQConfiguration config)
        {
            _forbid = forbid;
            _model = _forbid.Null(connectionProvider.Connection().CreateModel());
